...
*/
public class EcouteurJButtonRequeteProg implements ActionListener {
	
	/**
	 * La FenetreRequete à écouter
	 */
	private FenetreRequeteProg fr;
	 ...
	 */
	public EcouteurJButtonRequeteProg(FenetreRequeteProg fr, Connection maConnexion,FenetrePrincipale fp){
		this.fr=fr;
